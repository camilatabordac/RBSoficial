      ...
      <div className="container">
        ...
        <div className="relative h-[300px] sm:h-[400px] w-full">
          ...
          />
            ...
            <div className="absolute bottom-[4rem] md:bottom-[-1rem] left-2 bg-white rounded-xl shadow-lg p-2 md:p-4 flex items-center gap-2 md:gap-3 animate-fadeIn">
              <div className="h-5 w-8 md:h-12 md:w-12 rounded-full bg-[#55bbad]/10 flex items-center justify-center">
                <svg
                  className="h-4 w-4 md:h-6 md:w-6 text-[#55bbad]"
                  viewBox="0 0 24 24"
                  fill="none"
              ...
              <div>
                <p className="text-sm md:text-base font-bold text-gray-900">{siteConfig.stats.treatments}</p>
                <p className="text-[10px] md:text-xs text-gray-500">Tratamentos realizados</p>
              </div>
            </div>

            {/* Card Superior Direito */}
            <div className="absolute -top-8 md:top-1 right-1 bg-white rounded-xl shadow-lg p-2 md:p-4 flex items-center gap-2 md:gap-3 animate-fadeIn delay-300">
              <div className="h-8 w-8 md:h-12 md:w-12 rounded-full bg-[#55bbad]/10 flex items-center justify-center">
                <svg
                  className="h-4 w-4 md:h-6 md:w-6 text-[#55bbad]"
                  viewBox="0 0 24 24"
                  fill="none"
              ...
              <div>
                <p className="text-sm md:text-base font-bold text-gray-900">{siteConfig.stats.patients}</p>
                <p className="text-[10px] md:text-xs text-gray-500">Pacientes atendidos</p>
              </div>
            </div>
          </div>
        </div>
